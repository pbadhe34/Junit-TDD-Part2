...
public class AsyncTest {
    ...
    public static Future<Long> factorialUsingCompletableFuture(int number) {
        ...
        AsyncTest listener = new AsyncTest();
         
         //call back for completableFuture job done event
        completableFuture.thenAccept(listener::notify);        
    ...
    void notify(long value) {
        System.out.println("Received the data with completableFuture: " + value);
      }
    ...
    public static void main (String[] args) throws InterruptedException, ExecutionException {
		...
		/*
		 * Future<Long> futureTask = factorialUsingFutureTask(number);
		 * System.out.println("Factorial of " + number + " with futureTask is: " +
		 * futureTask.get());
		 */
